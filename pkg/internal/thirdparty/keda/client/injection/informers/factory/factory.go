...
import (
	...
	externalversions "github.com/markfisher/rokn/pkg/internal/thirdparty/keda/client/informers/externalversions"
	client "github.com/markfisher/rokn/pkg/internal/thirdparty/keda/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/markfisher/rokn/pkg/internal/thirdparty/keda/client/informers/externalversions.SharedInformerFactory from context.")
	}
